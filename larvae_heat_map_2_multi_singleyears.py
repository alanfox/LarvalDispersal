...
MPA_GROUPS = ([MPA_SOUTH,MPA_SOUTH,MPA_SOUTH,MPA_SOUTH])
#MPA_GROUPS = ([MPA_PORC,MPA_PORC,MPA_PORC])

RUN_NAME = ['baseline','baseline','behaviour2','behaviour2']
#RUN_NAME = ['baseline','behaviour2','doublelife']

RUN_YEAR = [1990,2001,1990,2001]
...
#    axarr.set_ylim([54, 65])
    axarr.set_xlim([-20, 13])
    axarr.set_ylim([35, 55])
...
#3 plots
#fig, axarr = plt.subplots(3,figsize = (3.5,7.3),sharex='col')
...
for MPA_SOURCE in MPA_GROUPS:
    ...
    for year in range(RUN_YEAR[icount],RUN_YEAR[icount]+1):
        year_str = str(year)
        print year
...
textstr = 'A'
#axarr[0,0].text(-14, 60,'A', fontsize = 8)
#axarr[0,1].text(-14, 60,'B', fontsize = 8)
#axarr[1,0].text(-14, 60,'C', fontsize = 8)
#axarr[1,1].text(-14, 60,'D', fontsize = 8)
axarr[0,0].text(-15, 61.2,'1990,  NAO +ve', fontsize = 8)
axarr[0,1].text(-15, 61.2,'2001,  NAO -ve', fontsize = 8)
axarr[0,1].text(-1.3, 59,'Active larvae', fontsize = 8,rotation=90)
axarr[1,1].text(-1.3, 59,'Passive larvae', fontsize = 8,rotation=90)
# 3 plots
...
cbaxes = fig.add_axes([0.07, 0.04, 0.875, 0.03]) 
...
#filenameroot = ('C:/Users/af26/Documents/Temp/' + 
#                 'heat_maps_baseline_singleyears')
#filenameroot = ('C:/Users/af26/Documents/Presentations/ATLASKickoff/' + 
#                 'heat_maps_baseline_rockallbank')
#
#plt.savefig(filenameroot + '.pdf')
#plt.savefig(filenameroot + '.eps', format='eps', dpi=1200)
#plt.savefig(filenameroot + '.png', dpi = 1200)
#            
